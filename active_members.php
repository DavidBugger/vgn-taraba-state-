...
<table class="table">
    ...
    <tbody>
        ...
        ?>
                    ...
                    <td><a class="btn btn-info" href="update2.php?id=<?php echo $row['register_no']; ?>">Edit</a>&nbsp;<a class="btn btn-danger" href="delete.php?id=<?php echo $row['register_no']; ?>">Delete</a></td>
